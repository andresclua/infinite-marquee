...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"js/horizontalLoop.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.horizontalLoop = horizontalLoop;
...
var _gsap = _interopRequireDefault(require("gsap"));
var _horizontalLoop = require("./js/horizontalLoop");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
window.addEventListener("load", function () {
  var text = _gsap.default.utils.toArray(".c--text-a__item__title");
  (0, _horizontalLoop.horizontalLoop)(text, {
    paused: false,
    repeat: -1
  });
  var imagesA = _gsap.default.utils.toArray(".js-marque-a");
  (0, _horizontalLoop.horizontalLoop)(imagesA, {
    paused: false,
    repeat: -1
  });
  var imagesB = _gsap.default.utils.toArray(".js-marque-b");
  (0, _horizontalLoop.horizontalLoop)(imagesB, {
    paused: false,
    repeat: -1,
    reversed: true
  });
  var imagesC = _gsap.default.utils.toArray(".js-marque-c");
  (0, _horizontalLoop.horizontalLoop)(imagesC, {
    paused: false,
    repeat: -1,
    speed: 0.25
  });
});
},{"gsap":"../node_modules/gsap/index.js","./js/horizontalLoop":"js/horizontalLoop.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
